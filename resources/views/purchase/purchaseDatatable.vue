<template>
      ...
      >
        <g id="freepik--background-complete--inject-2">
          ...
          <path
            ...
            style="fill: #e0e0e0"
          />
          <rect x="394.17" width="2.58" height="43.98" style="opacity: 0.2" />
        </g>
        <g id="freepik--Lamp--inject-2">
          <path
            ...
            style="fill: #181717"
          />
          <rect x="394.17" width="2.58" height="43.98" style="fill: #181717" />
        </g>
        ...
        <g id="freepik--Character--inject-2">
          ...
          />
          <path
            d="M554,180.37l-9,26-37.64,2-6.28,14,39.3,4A14.85,14.85,0,0,0,560,217.64l10.49-29.28Z"
            style="fill: #b78876"
          />
          <path
          ...
          />
          <path
            d="M575.18,437.71s-.29-.27-.55-.67-.42-.75-.37-.78.29.26.55.66S575.23,437.68,575.18,437.71Z"
            style="fill: #263238"
          />
          <path
            d="M576.6,437c0,.05-.32-.14-.62-.41s-.52-.52-.48-.56.32.14.62.41S576.64,436.91,576.6,437Z"
            style="fill: #263238"
          />
          <path
          ...
          />
          <path
            d="M588.22,438.35s-.09.24-.21.5-.18.5-.24.49-.09-.27.05-.58S588.18,438.3,588.22,438.35Z"
            style="fill: #263238"
          />
          <path
            d="M589.51,436.74s-.07.22-.25.4-.36.3-.41.26.07-.22.25-.41S589.46,436.69,589.51,436.74Z"
            style="fill: #263238"
          />
          <path
            d="M591.35,436c0,.06-.24.06-.5.15s-.44.23-.49.19.1-.28.42-.39S591.37,435.94,591.35,436Z"
            style="fill: #263238"
          />
          <path
            d="M592.66,435.64c0,.06-.07.15-.22.2s-.28.06-.3,0,.08-.15.22-.2S592.64,435.59,592.66,435.64Z"
            style="fill: #263238"
          />
          <path
          ...
          />
          <path
            d="M617.13,436.22s-.38-.12-.78-.38-.69-.51-.66-.56.38.12.78.38S617.16,436.17,617.13,436.22Z"
            style="fill: #263238"
          />
          <path
          ...
          />
          <path
            d="M629.29,431.47c.05,0,0,.25,0,.54s0,.53,0,.55-.2-.22-.2-.55S629.24,431.44,629.29,431.47Z"
            style="fill: #263238"
          />
          <path
            d="M629.8,429.47c.05,0,0,.23-.06.47s-.21.42-.26.4,0-.23.06-.47S629.74,429.45,629.8,429.47Z"
            style="fill: #263238"
          />
          <path
            d="M631.18,428c0,.06-.2.15-.4.34s-.31.39-.36.37,0-.3.22-.53S631.17,428,631.18,428Z"
            style="fill: #263238"
          />
          <path
            d="M632.23,427.18s0,.16-.12.27-.23.17-.27.13,0-.16.12-.27S632.19,427.14,632.23,427.18Z"
            style="fill: #263238"
          />
          <path
          ...
          />
          <polygon
            points="602.39 182.76 599.65 194.42 625.48 194.42 623.78 174.86 602.39 182.76"
            style="fill: #181717"
          />
          <path
          ...
          <g style="opacity: 0.30000000000000004">
            <path
              d="M577.77,184.87s5.74,42.57,21.88,41.44c0,0,7.27-.08,9.6-4.91v-1.9Z"
            />
          </g>
          <g style="opacity: 0.30000000000000004">
            <polygon
          ...
          />
          <path
            d="M576.74,146.87a21.66,21.66,0,0,0,11.46-2.75s-2.91,5.77-11.4,4.76Z"
            style="fill: #a36957"
          />
          <path
            d="M586.15,121c-.24.37-1.14.21-2.14,0s-1.88-.38-2-.81.93-1,2.27-.73S586.39,120.68,586.15,121Z"
            style="fill: #263238"
          />
          <path
          ...
          />
          <path
            d="M577.93,135.81a.58.58,0,0,0-.65.3.67.67,0,1,0,1.17,0,.67.67,0,0,0-.77-.33"
            style="fill: #a36957"
          />
          <path
          ...
          />
          <path
            d="M598.86,92c-.15,0-.73-5.34-1.31-12s-.94-12-.8-12,.73,5.34,1.31,12S599,92,598.86,92Z"
            style="fill: #263238"
          />
          <path
        ...
        <g id="freepik--speech-bubble--inject-2">
          ...
          />
          <path
            d="M513.06,107.58a1.53,1.53,0,1,1-1.63-1.42A1.52,1.52,0,0,1,513.06,107.58Z"
            style="fill: #181717"
          />
          <path
  ...
  <div v-else>
    ...
    <base-modal
    id="showPurchaseDetails"
    :footerButton="false"
    modelHeader="Purchase Details"
    :dropBack="true"
  >
    <template v-slot:modalBody>
      <div class="d-flex flex-column" v-if="purchaseDetails">
        <p class="fs-4">
          Name :
          <span style="font-weight: bold">{{
            purchaseDetails.supplier_name
          }}</span>
        </p>
        <p class="fs-4">invoice No : {{ purchaseDetails.invoice_number }}</p>
        <p class="fs-4">
          Transaction Date : {{ purchaseDetails.transaction_date }}
        </p>
        <p class="fs-4">Bill Date : {{ purchaseDetails.bill_date }}</p>
        <p class="fs-4">Bill No : {{ purchaseDetails.bill_no }}</p>
        <p class="fs-4">Lr No : {{ purchaseDetails.lr_no }}</p>
        <p class="fs-4">Total : {{ purchaseDetails.total_amount }}</p>
      </div>
...
import softDeletePurchase from "../../composables_api/purchase_api/softDelete";
import restoreTrashPurchase from "../../composables_api/purchase_api/restorePurchase";
import forceDeletePurchase from "../../composables_api/purchase_api/forceDeletePurchase";
...
export default {
  ...
  setup(props) {
    ...
    const modelToggle = ref(false);

    /**
     * * Importing the sweet alert and toast
     **/
    const swal = inject("$swal");
    const toast = inject("toast");

    /**
     * !Importing the composables
     **/
    ...
    const { softDeleteData, deletePurchase } = softDeletePurchase();
    const { restoredPurchase, restore } = restoreTrashPurchase();
    const { deletedPurchase, purchaseDeleteRequest } = forceDeletePurchase();
    ...
    /**
     * TODO: Function for table refresh
     **/
    ...
    /**
     * TODO: Soft deleting the purchase data
     **/
    ...
    /**
     * TODO: Watching the changes and refreshing the table
     **/
    watch(
      [
        pages,
    ...
    /**
     * TODO: Watch throw toast messages
     **/
    watch(deletedPurchase,()=>{
        toast.success("Data Deleted Permanently");
    })
    watch(softDeleteData,()=>{
        toast.success("Data Deleted Temporarily ");
    })
    watch(restoredPurchase,()=>{
        toast.success("Data Restored Successfully ");
    })


    /**
     * TODO: Restoring the trash data
     **/
    ...
    /**
     * TODO: Permanently Deleting the purchase trash data
     **/
    ...
    const forceDeleteHandler = (id) => {
      swal({
        ...
        if (isConfirm.value === true) {
            purchaseDeleteRequest(id);
        }
      });
    };

    /**
     * TODO: Get page Number and refresh table
     **/

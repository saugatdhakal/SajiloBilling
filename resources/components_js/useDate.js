...
export default function useDate(props) {
    ...
    const formattedYesterdayText = computed(() => formatNepali.value ? "हिजो" : "Yesterday");
    ...
    function getYesterday() {
        ...
        let month =date.value.month+1;
        let day =date.value.day -1;
